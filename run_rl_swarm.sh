...
pip3.11 install gensyn-genrl==0.1.4
pip3.11 install reasoning-gym>=0.1.20 # for reasoning gym env
pip3.11 install trl # for grpo config, will be deprecated soon
pip3.11 install hivemind@git+https://github.com/learning-at-home/hivemind@4d5c41495be082490ea44cce4e9dd58f9926bb4e # We need the latest, 1.1.11 is broken
